    ...
    accepts: [
      {
        ...
        maxAmountRequired: "3",
        resource: VERIFY_URL,
        description: "Verify payment to mint 1 or 3 NFTs",
...
app.post("/api/mint", async (req, res) => {
  try {
    ...
    // Минт 1 или 3 NFT
    const mintAmount = amount === 3 ? 3 : 1;

    // Здесь можно вставить код фактического mint, пока просто имитация
